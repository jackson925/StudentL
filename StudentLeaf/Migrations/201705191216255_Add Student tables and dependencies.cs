namespace StudentLeaf.Migrations
{
    ...
    public partial class AddStudenttablesanddependencies : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        LessonPlan = c.String(nullable: false),
                        Style = c.String(nullable: false),
                        Hours = c.Double(nullable: false),
                        SInstructor = c.String(nullable: false),
                        Student_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        DTG = c.DateTime(nullable: false),
                        LessonPlan = c.String(nullable: false),
                        Style = c.String(nullable: false),
                        InstructorId = c.Guid(nullable: false),
                        SInstructorId = c.Guid(nullable: false),
                        Student_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Students", t => t.Student_Id)
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.SessonRecords");
            DropTable("dbo.AspNetUserRoles");
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.ActiveLessons");
        }
    }
}
